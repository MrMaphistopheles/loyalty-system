...
const arr = [{ item: "tea" }, { item: "tea" }];

export default function Menu() {
  return (
    <Layout>
      <div className="flex h-full w-full flex-col items-center justify-center gap-3">
        <div className="flex max-h-[35em] min-h-[25em] w-full flex-col items-center justify-center gap-2 overflow-x-scroll px-2 pb-6">
          {arr.map((i, index) => (
            <div
        ...
        <div className="glass flex w-full items-center justify-center gap-3 rounded-2xl p-4">
          <Input variant="bordered" label="Категорія" size="sm" />
          <Button
            isIconOnly
            size="lg"
            className=" bg-black dark:bg-white dark:text-black"
